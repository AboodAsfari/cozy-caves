...
class DungeonBuilder {
    ...
    #roomConstruction(rW, rH, rX, rY){
        ...
        let room = this.#roomBuilder.setSize(new Point(roomWid, roomHgt)).setLeniency(new Point(widLeniency, hgtLeniency)).setAllowOvergrow(false).setPopulateWithItems(this.#rng() > 0.3).build();
